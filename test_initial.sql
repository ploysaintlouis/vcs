...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 23, 2019 at 09:36 AM
...
CREATE TABLE `m_fn_req_detail` (
  ...
  `functionNo` varchar(10) CHARACTER SET utf8 NOT NULL,
  `functionVersion` int(11) NOT NULL,
  `typeData` varchar(10) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE `m_fn_req_header` (
  ...
  `functionId` int(11) NOT NULL,
  `functionNo` varchar(10) CHARACTER SET utf8 NOT NULL,
  `functionversion` varchar(10) CHARACTER SET utf8 DEFAULT NULL,
  `functionDescription` varchar(50) CHARACTER SET utf8 NOT NULL,
  `createDate` date NOT NULL,
  `createUser` varchar(10) CHARACTER SET utf8 NOT NULL,
  `updateDate` date DEFAULT NULL,
  `updateUser` varchar(10) CHARACTER SET utf8 DEFAULT NULL,
...
CREATE TABLE `t_temp_change_list` (
  ...
  `newScaleLength` varchar(20) CHARACTER SET utf8 DEFAULT NULL,
  `newUnique` varchar(20) CHARACTER SET utf8 DEFAULT NULL,
  `newNotNull` varchar(20) CHARACTER SET utf8 DEFAULT NULL,
  `newDefaultValue` varchar(20) CHARACTER SET utf8 DEFAULT NULL,
  `newMinValue` varchar(20) CHARACTER SET utf8 DEFAULT NULL,
  `newMaxValue` varchar(20) CHARACTER SET utf8 DEFAULT NULL,
