<section class="content-header">
	...
	<div class="row">
		<div class="col-md-12">
			<div class="box box-primary">
            	...
            	<form role="form" action="<?php echo base_url() ?>index.php/TestCaseManagement/search/" method="post">
            				...
            				<div class="form-group">
    							<div class="col-sm-12">
    								<div align="right">
	            						...
	            						<a href="<?php echo base_url(); ?>index.php/TestCaseManagement/reset/">
	...
	<script type="text/javascript">
		function doOpenAddMoreScreen(){
			...
			if('' != projectId){
				window.location  = baseUrl + "index.php/TestCaseManagement/addMore/" + projectId;
				return false;
			}else{
