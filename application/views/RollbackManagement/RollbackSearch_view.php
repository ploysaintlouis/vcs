	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="box box-primary">
				<form role="form" action="<?php echo base_url() ?>index.php/Rollback/search/" method="post">
					...
					<table id="resultTbl" class="table table-striped">
						<tbody>
							<tr>
								...
								<th class="col-md-1">Change Date</th>
								<th class="col-md-1">Change User</th>
								<th class="col-md-3">
									Changed Functional Requirement ID
								</th>
								<th class="col-md-3">
									Changed Functional Version
								</th>
