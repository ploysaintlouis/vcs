<section class="content-header">
	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="box box-primary">
				  <form role="form" action="<?php echo base_url() ?>index.php/ApproveChange/search/" method="post">
						...
						<tbody>
			                ...
			                <tr class="<?php echo $classRow; ?>">
			                	...
			                	<td style="text-align: left;width: 40%;">
			                		<?php echo $value['functionDescription'] ?>
			                	</td>
                                ...
                                <input type="hidden" name="projectId" id="projectId" value="<?php echo $selectedProjectId; ?>">
	...
	$(function() {
		...
		window.location = baseUrl + "index.php/ApproveChange/view_detail/" + projectId + "/" + id + "/" +functionVersion ;	
		});
	});
</script>
