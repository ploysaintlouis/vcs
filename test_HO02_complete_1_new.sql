...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 25, 2019 at 07:22 PM
...
(7, 1, NULL, 8, 1, 8, 1, 1),
(8, 1, NULL, 9, 1, 9, 1, 1),
(9, 1, NULL, 10, 1, 11, 1, 1),
(10, 1, NULL, 10, 1, 12, 1, 1);
...
(5, 1, NULL, 5, 1, 'PATIENT'),
(6, 1, NULL, 6, 1, 'DOCTORS'),
(7, 1, NULL, 7, 1, 'DEPARTMENTS'),
(8, 1, NULL, 8, 1, 'APPOINTMENTS');
...
(5, '1', 10, '1 ', 2, 'FIRSTNAME', 136, 5, 'VARCHAR ', '30', NULL, 'N', 'Y', NULL, NULL, NULL, 'PATIENT', 'FIRSTNAME', 'edit', 'ploy', '2019-06-24', 44, 1, NULL),
(7, '1', 10, '1', 2, 'AGE', 0, 0, 'INT ', '', '', '', '', '', '', '', '', '', 'delete', 'ploy', '2019-06-25', 46, 1, NULL);
